...
public:
    // Constructor
    Map(int width, int height, std::pair<int,int> *level_data, GLuint texture_id, float tile_size, int
    ...
    std::pair<int,int>* const get_level_data() const { return m_level_data; }
